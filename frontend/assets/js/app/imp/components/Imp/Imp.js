...
const IMAGE_VIEW_ENDPOINT = '/api/imp/images/';
const ADJUST_GPS_ENDPOINT = '/api/imp/gps-adjust/';
export const OBJECT_VIEW_ENDPOINT = '/api/imp/objects/';
const WEBSOCKET_IMAGE_ENDPOINT = `ws://${window.location.host}/ws/imp/image/`;
const WEBSOCKET_OBJECT_ENDPOINT = `ws://${window.location.host}/ws/imp/object/`;
