...
urlpatterns = [
    ...
    url(r'api/interop/uastelemhistory$', views.uas_telem_history, name='interop.uas_telem_history'),
    url(r'api/interop/teamtelemhistory$', views.team_telem_history, name='interop.team_telem_history'),
