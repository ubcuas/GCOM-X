...
class UasTelemetry_admin(admin.ModelAdmin):
    list_display = ('team_id', 'latitude', 'longitude', 'altitude_msl',
                    'uas_heading', 'groundspeed_m_s', 'chan3_raw', 'created_at', 'uploaded')
...
class OrderedWayPoint_admin(admin.ModelAdmin):
    list_display = ('mission', 'order', 'latitude',
                    'longitude', 'altitude_msl')
